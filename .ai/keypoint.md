...
- 菜单栏打开“记忆力”或“设置”窗口时要 show/unminimize/focus，并在 macOS 上短暂置顶后恢复，避免被其他窗口盖住。
...
- 像素通知宽 360px、最小高 152px，主卡宽 312px、最小高 116px；多行内容动态增高，主框、叠层、尖角与投影由运行时 SVG 几何同步生成。
...
- 不要在 clamp 前仅用完整包含判断淘汰提醒候选；屏幕边缘应先平移候选，再检查是否与宠物相交。
